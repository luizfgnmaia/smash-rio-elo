...
Valor inicial do elo: 1500, parâmetro k é 20 $\times$ participants/24 para bo3 e 30 $\times$ participants/48 para bo5, resultado é dado por score1/(score1 + score2).
...
for (i in 1:ultima_row_penultimo_camp) {
  ...
  new_elo[1, 1] = ifelse(new_elo[1, 1] < 1420, 1420, new_elo[1, 1])
  new_elo[1, 2] = ifelse(new_elo[1, 2] < 1420, 1420, new_elo[1, 2])
